    ...
    <section className="bg-white section-padding">
      <div className="container-custom">
          ...
          <div>
            ...
            <div className="space-y-4">
              {modules.map((module, index) => (
                <div 
                  key={index}
                  className="bg-warm-50 p-6 rounded-xl border border-peach-100 hover:shadow-md transition-all duration-300"
                >
        ...
        <div className="text-center mt-16">
          <div className="bg-gradient-to-r from-primary to-rose-400 text-white p-8 rounded-3xl">
            ...
            <button className="bg-white text-primary hover:bg-warm-50 font-bold py-4 px-8 rounded-full text-lg transition-all duration-300 hover:scale-105 shadow-lg">
