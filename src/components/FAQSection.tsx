      ...
      <div className="container-custom">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-display font-bold text-gray-800 mb-4">
            Dúvidas{' '}
            <span className="text-zinc-950">Frequentes</span>
          </h2>
        ...
        <div className="max-w-4xl mx-auto">
          <Accordion type="single" collapsible className="space-y-4">
            {faqs.map((faq, index) => <AccordionItem key={index} value={`item-${index}`} className="bg-warm-50 rounded-2xl border border-peach-100 px-6">
        ...
        <div className="text-center mt-16">
          <div className="bg-gradient-to-r from-rose-50 to-peach-50 p-8 rounded-3xl border border-rose-100 max-w-3xl mx-auto">
            ...
            <a href="https://wa.me/41998794228" target="_blank" rel="noopener noreferrer" className="inline-block bg-yellow-200 text-slate-800 hover:bg-yellow-300 transition-all duration-300 rounded-full px-6 py-3 font-medium border border-yellow-400 text-center w-full sm:w-auto">
