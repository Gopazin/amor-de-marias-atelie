...
const FreeClassSection = () => {
  ...
  return <section className="bg-gradient-to-r from-yellow-400 to-yellow-500 py-16">
      <div className="container-custom">
        <div className="text-center space-y-6">
          ...
          <h2 className="text-3xl md:text-4xl font-display font-bold text-zinc-950">
            Quer Experimentar Antes de Comprar?
          </h2>
          
          <p className="text-xl max-w-2xl mx-auto text-zinc-950">
          ...
          <button onClick={openModal} className="inline-flex items-center justify-center bg-white text-yellow-600 px-8 py-4 rounded-full font-semibold text-lg hover:bg-yellow-50 transition-colors group">
